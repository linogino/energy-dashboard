...
# ── 品目別ターゲット定義 ─────────────────────────────────────────────────────
# code: (品目名, グループ名)
# 経産省 IIP 品目別・月別 Excel のコードに対応
TARGET_PRODUCTS: dict[str, tuple[str, str]] = {
    # === アルミニウム ===
    "1101202040": ("アルミニウムはく",                    "アルミニウム"),
    "1102006020": ("産業用アルミニウム製品",              "アルミニウム"),
    # === 石油化学基礎製品 (1109102xxx) ===
    "1109102010": ("エチレン",                           "石油化学基礎製品"),
    "1109102020": ("プロピレン",                         "石油化学基礎製品"),
    "1109102030": ("純ベンゼン",                         "石油化学基礎製品"),
    "1109102040": ("純トルエン",                         "石油化学基礎製品"),
    "1109102050": ("キシレン",                           "石油化学基礎製品"),
    # === 石油化学誘導品・中間体 (1109101/103/104xxx) ===
    "1109101010": ("苛性ソーダ",                         "石油化学誘導品・中間体"),
    "1109103010": ("合成アセトン",                       "石油化学誘導品・中間体"),
    "1109103020": ("エチレングリコール",                  "石油化学誘導品・中間体"),
    "1109103030": ("二塩化エチレン",                     "石油化学誘導品・中間体"),
    "1109103040": ("ポリプロピレングリコール",            "石油化学誘導品・中間体"),
    "1109103050": ("アクリロニトリル",                   "石油化学誘導品・中間体"),
    "1109103060": ("酢酸ビニルモノマー",                 "石油化学誘導品・中間体"),
    "1109103070": ("ブタジエン",                         "石油化学誘導品・中間体"),
    "1109103080": ("メタクリル酸エステルモノマー",        "石油化学誘導品・中間体"),
    "1109104010": ("環式中間物（除．石油化学製品）",      "石油化学誘導品・中間体"),
    "1109104020": ("高純度テレフタル酸",                 "石油化学誘導品・中間体"),
    "1109104030": ("スチレンモノマー",                   "石油化学誘導品・中間体"),
    "1109104040": ("カプロラクタム",                     "石油化学誘導品・中間体"),
    "1109104050": ("フェノール",                         "石油化学誘導品・中間体"),
    "1109104060": ("ビスフェノールＡ",                   "石油化学誘導品・中間体"),
    "1109104070": ("パラキシレン",                       "石油化学誘導品・中間体"),
    # === 合成樹脂・ゴム (1109105/106xxx) ===
    "1109105010": ("フェノール樹脂",                     "合成樹脂・ゴム"),
    "1109105020": ("ポリエチレン",                       "合成樹脂・ゴム"),
    "1109105030": ("ポリスチレン",                       "合成樹脂・ゴム"),
    "1109105040": ("ポリプロピレン",                     "合成樹脂・ゴム"),
    "1109105050": ("塩化ビニル樹脂",                     "合成樹脂・ゴム"),
    "1109105060": ("エポキシ樹脂",                       "合成樹脂・ゴム"),
    "1109105070": ("ポリビニルアルコール",                "合成樹脂・ゴム"),
    "1109105080": ("ポリアミド系樹脂成形材料",           "合成樹脂・ゴム"),
    "1109105090": ("ふっ素樹脂",                         "合成樹脂・ゴム"),
    "1109105100": ("ポリエチレンテレフタレート",          "合成樹脂・ゴム"),
    "1109105110": ("ポリカーボネート",                   "合成樹脂・ゴム"),
    "1109105120": ("ウレタンフォーム",                   "合成樹脂・ゴム"),
    "1109106010": ("合成ゴム",                           "合成樹脂・ゴム"),
    "1109106020": ("コールタール製品",                   "合成樹脂・ゴム"),
    # === その他化学 (1109201/202/203xxx) ===
    "1109201010": ("アンモニア",                         "その他化学"),
    "1109201020": ("複合肥料",                           "その他化学"),
    "1109202010": ("溶剤系合成樹脂塗料",                 "その他化学"),
    "1109202020": ("水系合成樹脂塗料",                   "その他化学"),
    "1109203020": ("合成洗剤",                           "その他化学"),
    "1109203030": ("界面活性剤",                         "その他化学"),
    # === 石油製品 (1111xxx) ===
    "1111001010": ("ガソリン",                           "石油製品"),
    "1111001020": ("ナフサ",                             "石油製品"),
    "1111001030": ("ジェット燃料油",                     "石油製品"),
    "1111001040": ("灯油",                               "石油製品"),
    "1111001050": ("軽油",                               "石油製品"),
    "1111001060": ("重油",                               "石油製品"),
    # === プラスチック製品 (1112xxx) ===
    "1112001020": ("プラスチック製フィルム・シート",       "プラスチック製品"),
    "1112001030": ("プラスチック製建材",                  "プラスチック製品"),
    "1112001040": ("強化プラスチック製品",                "プラスチック製品"),
    "1112002010": ("プラスチック製機械器具部品",           "プラスチック製品"),
    "1112003010": ("発泡プラスチック製品",                "プラスチック製品"),
    "1112004010": ("プラスチック製日用品・雑貨",           "プラスチック製品"),
    "1112004020": ("プラスチック製容器（中空成形）",       "プラスチック製品"),
    "1112004030": ("プラスチック製容器（中空成形以外）",   "プラスチック製品"),
    # === パルプ・紙・包装 (1113xxx) ===
    "1113001010": ("製紙パルプ",                         "パルプ・紙・包装"),
    "1113002010": ("新聞巻取紙",                         "パルプ・紙・包装"),
    "1113002020": ("印刷用紙（非塗工類）",               "パルプ・紙・包装"),
    "1113002030": ("印刷用紙（塗工）",                   "パルプ・紙・包装"),
    "1113002040": ("情報用紙",                           "パルプ・紙・包装"),
    "1113002050": ("衛生用紙",                           "パルプ・紙・包装"),
    "1113003010": ("段ボール原紙",                       "パルプ・紙・包装"),
    "1113003020": ("紙器用板紙",                         "パルプ・紙・包装"),
    "1113004010": ("段ボールシート",                     "パルプ・紙・包装"),
    "1113004020": ("大人用紙おむつ",                     "パルプ・紙・包装"),
    "1113004030": ("乳幼児用紙おむつ",                   "パルプ・紙・包装"),
}
...
# 品目名 → (コード, グループ) の逆引き用
_PRODUCT_NAME_TO_CODE: dict[str, str] = {v[0]: k for k, v in TARGET_PRODUCTS.items()}

# IIP 主要業種名（後方互換のため残す — Excel の name-match で使用されない）
INDUSTRY_NAMES_JA: list[str] = []
...
# TARGET_PRODUCTS のコードをそのまま照合用マップとして使う
MAJOR_INDUSTRY_CODES: dict[str, str] = {
    code: name for code, (name, group) in TARGET_PRODUCTS.items()
}
...
def _is_major_industry(code_val, name_val):
    """
    TARGET_PRODUCTS に含まれる品目かどうか判定。
    コード → 品目名 の順に照合。
    """
    code_s = str(code_val).strip() if pd.notna(code_val) else ""
    name_s = str(name_val).strip() if pd.notna(name_val) else ""

    # float 表現 (例: "1109102010.0") の小数を除去
    code_s = re.sub(r'\.0+$', '', code_s)

    # コードで照合（最優先）
    if code_s in TARGET_PRODUCTS:
        return TARGET_PRODUCTS[code_s][0]   # 品目名を返す

    # 品目名で逆引き
    if name_s in _PRODUCT_NAME_TO_CODE:
        return name_s

    return None  # 対象品目ではない
...
def parse_iip_excel(excel_src):
    ...
    # TARGET_PRODUCTS に含まれる品目のみに絞り込む
    industries = [i for i in industries if i["name"] in _PRODUCT_NAME_TO_CODE]

    # group フィールドを付与
    for ind in industries:
        code = _PRODUCT_NAME_TO_CODE.get(ind["name"])
        ind["group"] = TARGET_PRODUCTS[code][1] if code else "その他"

    # グループ順 → グループ内はコード順
    _group_rank = {g: i for i, g in enumerate(PRODUCT_GROUP_ORDER)}
    _code_rank  = {v[0]: i for i, (k, v) in enumerate(TARGET_PRODUCTS.items())}

    def sort_key(ind):
        g = ind.get("group", "その他")
        return (_group_rank.get(g, 99), _code_rank.get(ind["name"], 99))
...
def fallback_demo_data():
    ...
    ホルムズ封鎖・ナフサ不足を反映した推計値（2020年=100）。
    ...
    # (name, group, prod, inv, prod_yoy%, inv_yoy%)
    # prod/inv は 2020年=100 の指数。在庫率 = inv ÷ prod
    products_raw = [
        # === アルミニウム ===
        ("アルミニウムはく",               "アルミニウム",          88.5,  90.2,  -3.2,  +1.5),
        ("産業用アルミニウム製品",         "アルミニウム",          85.3,  87.1,  -4.8,  +0.8),
        # === 石油化学基礎製品 ===
        ("エチレン",                       "石油化学基礎製品",      75.7,  72.0,  -12.3, -8.5),
        ("プロピレン",                     "石油化学基礎製品",      77.3,  73.5,  -11.8, -7.2),
        ("純ベンゼン",                     "石油化学基礎製品",      82.5,  79.8,  -9.1,  -5.3),
        ("純トルエン",                     "石油化学基礎製品",      80.2,  77.5,  -9.8,  -4.8),
        ("キシレン",                       "石油化学基礎製品",      79.5,  76.8,  -10.2, -5.1),
        # === 石油化学誘導品・中間体 ===
        ("苛性ソーダ",                     "石油化学誘導品・中間体", 85.2,  88.0,  -5.1,  +1.8),
        ("合成アセトン",                   "石油化学誘導品・中間体", 83.5,  85.2,  -6.3,  -0.5),
        ("エチレングリコール",             "石油化学誘導品・中間体", 78.5,  80.2,  -10.5, -2.3),
        ("二塩化エチレン",                 "石油化学誘導品・中間体", 76.2,  74.8,  -11.2, -8.7),
        ("ポリプロピレングリコール",       "石油化学誘導品・中間体", 82.0,  84.1,  -7.5,  -1.2),
        ("アクリロニトリル",               "石油化学誘導品・中間体", 75.3,  73.1,  -12.8, -9.5),
        ("酢酸ビニルモノマー",             "石油化学誘導品・中間体", 79.8,  81.5,  -9.2,  -2.1),
        ("ブタジエン",                     "石油化学誘導品・中間体", 74.2,  70.5,  -13.1, -9.2),
        ("メタクリル酸エステルモノマー",   "石油化学誘導品・中間体", 80.3,  82.0,  -8.8,  -1.8),
        ("環式中間物（除．石油化学製品）", "石油化学誘導品・中間体", 84.5,  82.3,  -6.2,  -5.8),
        ("高純度テレフタル酸",             "石油化学誘導品・中間体", 83.2,  85.0,  -7.3,  -1.5),
        ("スチレンモノマー",               "石油化学誘導品・中間体", 80.8,  82.5,  -8.5,  -1.9),
        ("カプロラクタム",                 "石油化学誘導品・中間体", 78.2,  79.8,  -10.3, -3.2),
        ("フェノール",                     "石油化学誘導品・中間体", 81.5,  83.2,  -7.8,  -2.0),
        ("ビスフェノールＡ",               "石油化学誘導品・中間体", 80.2,  82.0,  -8.2,  -1.8),
        ("パラキシレン",                   "石油化学誘導品・中間体", 81.3,  78.5,  -8.7,  -4.5),
        # === 合成樹脂・ゴム ===
        ("フェノール樹脂",                 "合成樹脂・ゴム",        83.2,  85.0,  -7.3,  -1.5),
        ("ポリエチレン",                   "合成樹脂・ゴム",        76.5,  78.2,  -11.8, -3.2),
        ("ポリスチレン",                   "合成樹脂・ゴム",        79.3,  81.0,  -9.5,  -2.5),
        ("ポリプロピレン",                 "合成樹脂・ゴム",        74.8,  76.5,  -12.5, -4.1),
        ("塩化ビニル樹脂",                 "合成樹脂・ゴム",        77.2,  79.0,  -10.8, -2.9),
        ("エポキシ樹脂",                   "合成樹脂・ゴム",        82.5,  84.2,  -7.5,  -1.3),
        ("ポリビニルアルコール",           "合成樹脂・ゴム",        80.5,  82.2,  -8.2,  -1.7),
        ("ポリアミド系樹脂成形材料",       "合成樹脂・ゴム",        85.2,  87.0,  -5.8,  -0.8),
        ("ふっ素樹脂",                     "合成樹脂・ゴム",        88.3,  90.1,  -4.2,  +0.5),
        ("ポリエチレンテレフタレート",     "合成樹脂・ゴム",        84.5,  86.2,  -6.3,  -1.1),
        ("ポリカーボネート",               "合成樹脂・ゴム",        87.2,  89.0,  -4.8,  +0.2),
        ("ウレタンフォーム",               "合成樹脂・ゴム",        81.5,  83.2,  -8.0,  -1.8),
        ("合成ゴム",                       "合成樹脂・ゴム",        78.2,  80.0,  -10.5, -2.5),
        ("コールタール製品",               "合成樹脂・ゴム",        90.5,  92.3,  -3.2,  +1.2),
        # === その他化学 ===
        ("アンモニア",                     "その他化学",            88.5,  72.3,  -5.8,  -12.5),
        ("複合肥料",                       "その他化学",            82.3,  68.0,  -8.2,  -15.3),
        ("溶剤系合成樹脂塗料",             "その他化学",            85.2,  87.0,  -5.5,  -1.2),
        ("水系合成樹脂塗料",               "その他化学",            87.5,  89.3,  -4.5,  -0.8),
        ("合成洗剤",                       "その他化学",            90.3,  92.1,  -3.5,  +0.5),
        ("界面活性剤",                     "その他化学",            88.8,  90.6,  -4.2,  -0.3),
        # === 石油製品 ===
        ("ガソリン",                       "石油製品",             107.2,  78.5,  +5.8,  -9.1),
        ("ナフサ",                         "石油製品",              82.3,  68.5,  -8.5,  -12.3),
        ("ジェット燃料油",                 "石油製品",              95.2,  75.3,  +2.5,  -7.8),
        ("灯油",                           "石油製品",              98.5,  72.0,  +3.2,  -8.5),
        ("軽油",                           "石油製品",             105.3,  80.2,  +4.8,  -6.2),
        ("重油",                           "石油製品",             100.5,  82.8,  +2.3,  -5.8),
        # === プラスチック製品 ===
        ("プラスチック製フィルム・シート", "プラスチック製品",      68.2,  72.0,  -14.1, -6.3),
        ("プラスチック製建材",             "プラスチック製品",      72.5,  74.8,  -12.3, -5.1),
        ("強化プラスチック製品",           "プラスチック製品",      75.8,  78.0,  -11.2, -4.5),
        ("プラスチック製機械器具部品",     "プラスチック製品",      78.5,  80.8,  -9.8,  -3.2),
        ("発泡プラスチック製品",           "プラスチック製品",      75.5,  77.8,  -11.5, -4.2),
        ("プラスチック製日用品・雑貨",     "プラスチック製品",      74.2,  76.5,  -12.0, -4.8),
        ("プラスチック製容器（中空成形）", "プラスチック製品",      72.8,  75.0,  -12.8, -5.3),
        ("プラスチック製容器（中空成形以外）", "プラスチック製品",  73.5,  75.8,  -12.5, -5.0),
        # === パルプ・紙・包装 ===
        ("製紙パルプ",                     "パルプ・紙・包装",      95.3,  97.8,  -2.5,  +0.8),
        ("新聞巻取紙",                     "パルプ・紙・包装",      88.2,  90.5,  -5.8,  -1.2),
        ("印刷用紙（非塗工類）",           "パルプ・紙・包装",      90.5,  92.8,  -4.8,  -0.5),
        ("印刷用紙（塗工）",               "パルプ・紙・包装",      88.8,  91.0,  -5.5,  -0.8),
        ("情報用紙",                       "パルプ・紙・包装",      85.3,  87.5,  -7.2,  -1.5),
        ("衛生用紙",                       "パルプ・紙・包装",     102.5, 105.0,  +2.5,  +3.2),
        ("段ボール原紙",                   "パルプ・紙・包装",      93.5,  96.0,  -3.5,  +0.2),
        ("紙器用板紙",                     "パルプ・紙・包装",      90.8,  93.2,  -5.0,  -0.5),
        ("段ボールシート",                 "パルプ・紙・包装",      94.3,  96.8,  -3.2,  +0.5),
        ("大人用紙おむつ",                 "パルプ・紙・包装",     105.2, 107.8,  +4.5,  +5.2),
        ("乳幼児用紙おむつ",               "パルプ・紙・包装",     100.3, 102.8,  +2.8,  +3.5),
    ]

    industries = []
    for name, group, prod, inv, prod_yoy, inv_yoy in products_raw:
        # 12ヶ月履歴 2025年3月〜2026年2月
        hist_months = []
        for i in range(12):
            offset = i - 11
            yr, mo = DEMO_YEAR, DEMO_MONTH + offset
            while mo <= 0:
                mo += 12
                yr -= 1
        ...
        for idx, (yr, mo) in enumerate(hist_months):
            # 後半（直近2ヶ月）ほど影響大きく
            trend = 1.0 - max(0, (idx - 9) * 0.04)
            pv = round(prod * trend * (1 + 0.01 * math.sin(idx * 0.6)), 1)
            iv = round(inv  * trend * (1 + 0.008 * math.cos(idx * 0.5)), 1)
